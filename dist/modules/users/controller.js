...
exports.favoriteGame = exports.remove = exports.update = exports.create = exports.list = void 0;
   ...
   */
    ...
    */
    ...
    try {
        ...
        const user = await usersConsults_1.default.create({ name, email, password: password_hash, role });
